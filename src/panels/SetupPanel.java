...
public class SetupPanel extends JPanel {
    ...
    private LongPathCard longTicket;
    private boolean[] clicked;
    private ArrayList<LongPathCard> longPaths;
    private ArrayList<NormalPathCard> normalPaths;
    private Player player;

    public SetupPanel(ArrayList<LongPathCard> longPaths, ArrayList<NormalPathCard> normalPaths, Player p) {
        this.longPaths = longPaths;
        this.normalPaths = normalPaths;
        ticketArray = new NormalPathCard[3];
        ticketButtons = new JButton[4];
    ...
    public void setupPanel(){ 
        ...
        confirm.setBounds(Rel.X(190), Rel.Y(850), Rel.W(120), Rel.H(50));

        infoLabel = new JLabel("Select at least 2 tickets");
        ...
        longTicket = longPaths.remove(longPaths.size() - 1);
        ticketButtons[3] = new JButton();
        ticketButtons[3].setIcon(longTicket.getFront());
        ticketButtons[3].setBounds(Rel.X(150), Rel.Y(y), Rel.W(200), Rel.H(125));
    ...
    public void updateForNextPlayer(Player p) {
        player = p;
        int y = 200;
        clicked = new boolean[4];
        bottom.setText("Player " + (player.getNumber() + 1));
        ...
        longTicket = longPaths.remove(longPaths.size() - 1);
        ticketButtons[3].setIcon(longTicket.getFront());
        ticketButtons[3].setBorder(null);
    }
    ...
    public ArrayList<LongPathCard> getLongPaths() {
        return longPaths;
    }
    ...
    public LongPathCard getLongTicket() {
        return longTicket;
    }
}
